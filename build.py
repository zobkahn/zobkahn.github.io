...
def build_index(profile_json, news_json, pubs_json, students_json, links):
    ...
    body_html += "<div class='subtitle'><h2><a href='resume.pdf', download='EmilyAikenResume.pdf'>CV</a> | <a href='https://scholar.google.com/citations?user=qL2LCqIAAAAJ&hl=en'>Google Scholar</a>| <a href='mailto:zkahn@berkeley.edu'> zkahn@berkeley.edu</a></h2></div>\n"
